...
106.Ship lock operation. 船闸运作  (Step graph)
...
109.Tomato processing cycle. 番茄加工周期  (Step graph)
...
110.Bottle recycling. 瓶子回收  (Step graph)
...
120.Step to make instant coffee. 速溶咖啡制作步骤  (Step graph)
...
105.Air Composition. 空气成分  (Pie chart)
...
118.Study foreign languages. 外语学习  (Pie chart)
...
122.Households in Millions Who Own Pets. 养宠物的百万家庭数  (Pie chart)
...
115.Annual working hours. 年工作时长  (Line graph)
...
121.Mobile phone ownership. 手机拥有率  (Line graph)
...
123.UK unemployment rate. 英国失业率  (Line graph)
...
128.Arrests number for using illegal drugs. 吸毒逮捕人数  (Line graph)
...
103.Internet users. 互联网用户  (Bar chart)

![](../../img/DI/Internet_users.jpg)

The bar chart shows Internet users who accessed via a mobile phone in 2011. From the graph, we can see that the largest proportion can be found in the 16 24 age group, which is 71. The second largest proportion can be found in those aged between 25 and 34, which is 65. While the smallest proportion can be found in those aged over 65, which is only 9. Overall, young people prefer to access the internet via their smartphones.

113.Age group. 年龄组  (Bar chart)
...
114.Chocolate consumers. 巧克力消费者  (Bar chart)
...
119.Mean salary. 平均薪资  (Bar chart)
...
126.Largest Population Increase. 最大人口增长  (Bar chart)
...
129.Change of Primary Funding Sources. 主要资金来源变化 (Table)
...
101.Population density. 人口密度  (Map graph)
...
111.European countries. 欧洲国家  (Map graph)
...
124.Nuclear power generation. 核能发电  (Map graph)
...
127.Map of Warm & Cold Currents. 暖流寒流地图  (Map graph)
...
104.Ice thickness guidelines. 冰层厚度指南  (Image)
...
107.Renewable energy. 可再生能源  (Image)
...
112.Weekly household spending. 家庭周支出  (Image)
...
117.Students at the lab. 实验室学生  (Image)
